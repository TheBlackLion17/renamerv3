...
# Handler for incoming messages containing documents, audio, or video files
...
# Handler for user replies to prompt for renaming
@Client.on_message(filters.private & filters.reply)
async def refunc(client, message):
    # Get the replied message
    reply_message = message.reply_to_message

    # Check if the replied message contains a ForceReply markup
